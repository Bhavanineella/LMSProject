package librarymanagementsystemspring.validation;
...
public class Validation {
	...
	//	String nameRegEx = "^[A-Za-z\\s]{1,}[\\.]{0,1}[A-Za-z\\s]{0,}$" ;
		...
		if (matcher.matches()) {
			...
			throw new LibraryException("Name should contains only Alpabets");
		}
		return result;
	}
	...
	public boolean validatedEmail(String email) throws LibraryException {
		...
		if (matcher.matches()) {
			...
			throw new LibraryException("Enter proper email i.e., it should consist of numbers and alphabets");
		}
		return result;
	}
